...
function PANEL:Paint(w, h)
	...
	draw.SimpleText(t1..(stat and stat:IsValid() and stat:GetDTInt(1) ~= 0 and "|"..stat:GetDTInt(1) or ""), ((stat and stat:IsValid() and stat:GetDTInt(1) ~= 0)  and "ZSHUDFontSmaller" or t1 >= 10000 and "ZSHUDFontSmallest" or "ZSHUDFontSmall"), w / 2, y + h / 2.8 - boxsize/2 + 5, color_white_alpha230, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	if nm then
